                            ...
                            <div class="card-body">
                                ...
                                <div class="row gy-3 justify-content-center">
                                    <div class="col-12 col-sm-6 col-md-3">
                                        <div
                                            class="d-flex flex-column align-items-center p-3 border rounded bg-light h-100">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-3">
                                        <div
                                            ...
                                            @elseif (
                                                $permohonanTransactions->permohonanBiling->path != null &&
                                                    $permohonanTransactions->permohonanBiling->is_valid == false)
                                                <i class="mdi mdi-timer-sand text-warning fs-2"></i>
                                            @else
                                                <i class="mdi mdi-check-circle text-success fs-2"></i>
                                            @endif
                                    ...
                                    <div class="col-12 col-sm-6 col-md-3">
                                        <div
                                            ...
                                            @if (isset($permohonanTransactions) &&
                                                    ($permohonanTransactions->status == 'PEMASANGAN SELESAI' || $permohonanTransactions->status == 'SELESAI'))
                                                <i class="mdi mdi-check-circle text-success fs-2"></i>
                                ...
                                <div class="row">
                                    <ul class="list-group list-group-flush mb-3">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <span><i class="mdi mdi-calendar-check-outline me-2"></i>Tanggal
                                                Permohonan</span>
                                        ...
                                        @if ($permohonanTransactions->no_register != null)
                                            ...
                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="{{ route('pdf.permohonan', Crypt::encrypt($permohonanTransactions->id)) }}"
                                                ...
                                                @foreach ($dokumenPendukung as $dokumen)
                                                    <li
                                                        ...
                                                        @if (!empty($dokumen->file_name))
                                                            <span
                                                                class="badge bg-secondary">{{ $dokumen->file_name }}</span>
                                                        @endif
                                                    </li>
                                                @endforeach
                                            @else
                        ...
                        <div class="row text-center">
                            <div class="col-md-6 mb-3">
                                <div class="d-flex flex-column align-items-center shadow-sm p-3 rounded bg-light h-100">
                                    <i class="mdi mdi-check-circle fs-2 text-success mb-2"></i>
                                    <span class="fw-semibold">Hasil Pemasangan</span>
                                    <h6 class="mb-0 mt-1">
                                        <span class="badge bg-success">Selesai</span>
                                    </h6>
                                    <h6 class="mb-0 mt-1">
                                        Tanggal pemasangan :
                                        {{ \Carbon\Carbon::parse($permohonanTransactions->permohonanOfficer->done_at)->locale('id')->translatedFormat('d F Y H:i:s') }}
                                        WIB
                                    </h6>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex flex-column align-items-center shadow-sm p-3 rounded bg-light h-100">
                                    <i class="mdi mdi-file-check-outline fs-2 text-primary mb-2"></i>
                                    <span class="fw-semibold">Mohon Konfirmasi Hasil Pemasangan</span>
                                    <button class="btn btn-primary mt-2" id="btn-konfirmasi-pemasangan">
                                        <i class="mdi mdi-check"></i> Konfirmasi Hasil Pemasangan
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-6 text-center">
                                ...
                                <span
                                    class="fw-semibold">{{ $permohonanTransactions->permohonanBiling->no_va ?? '-' }}</span>
                                <h6 class="fw-semibold my-3">Nominal Pembayaran</h6>
                                <span class="fw-semibold">Rp.
                                    {{ number_format($permohonanTransactions->permohonanBiling->price, 0, ',', '.') ?? '-' }}</span>
                            </div>
                            <div class="col-6 text-center">
                        ...
                        @if (!empty($permohonanTransactions->permohonanBiling) && $permohonanTransactions->permohonanBiling->is_valid == false)
                            <div class="row mb-3">
                                <form id="form-upload-bukti-pembayaran" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="permohonan_transaction_id"
                                        value="{{ $permohonanTransactions->id ?? null }}">
                                    <div class="col-12 text-center">
                                        <h6>Unggah Bukti Pembayaran</h6>
                                        <p class="text-muted">Format file yang diizinkan: PDF, JPG, JPEG, PNG. Maksimal 2MB
                                        </p>
                        ...
                        <div class="row text-center">
                            <div class="col-md-6 mb-3">
                                <div class="d-flex flex-column align-items-center shadow-sm p-3 rounded bg-light h-100">
                                    ...
                                    <h6 class="mb-0 mt-1">
                                        {{ optional($permohonanTransactions->permohonanOfficer->petugas)->name ?? '-' }}
                                    </h6>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex flex-column align-items-center shadow-sm p-3 rounded bg-light h-100">
                                    ...
                                    <h6 class="mb-0 mt-1">
                                        {{ optional($permohonanTransactions->permohonanOfficer->msMeteran)->nama ?? '-' }}
                                    </h6>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex flex-column align-items-center shadow-sm p-3 rounded bg-light h-100">
                                    ...
                                    <h6 class="mb-0 mt-1">
                                        {{ $permohonanTransactions->permohonanOfficer->nomor_seri ?? '-' }}</h6>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex flex-column align-items-center shadow-sm p-3 rounded bg-light h-100">
...
@push('scripts')
    ...
    <script>
        ...
        $('#btn-konfirmasi-pemasangan').on('click', function(e) {
            e.preventDefault();

            swal.fire({
                title: 'Yakin ingin konfirmasi hasil pemasangan?',
                text: 'Permohonan akan dikonfirmasi sebagai selesai.',
                icon: 'warning',
